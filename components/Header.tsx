      ...
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="flex-1 mx-8 overflow-hidden hidden sm:block">
          <div className="whitespace-nowrap animate-marquee font-bold text-sm uppercase">
            $CATL IS COMING • MAKE CATLANDIA GREAT AGAIN • NO UTILITY • JUST VIBES • $CATL IS COMING • MAKE CATLANDIA GREAT AGAIN • NO UTILITY • JUST VIBES •
          </div>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <a href="#giveaway" className="bg-[#D12B2B] text-white px-4 py-1 comic-border font-bold text-sm transition-transform active:scale-95">
            JOIN WIN
          </a>
        </div>
      </div>
