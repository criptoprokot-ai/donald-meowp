    ...
    <section className="relative overflow-hidden px-4 py-8">
      <div className="container mx-auto max-w-4xl">
        <div className="relative comic-border bg-[#D12B2B] comic-shadow p-8 md:p-12">
          {/* Badge */}
          <div className="absolute -top-4 right-8 bg-black text-[#D4AF37] comic-border px-6 py-2 font-comic text-2xl font-black uppercase tracking-wide">
            FREE SOL
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col items-center justify-center gap-6">
              ...
              <a 
                href="#giveaway" 
                className="bg-black text-white px-12 py-6 comic-border comic-shadow comic-shadow-hover font-comic text-3xl tracking-wide uppercase transition-all transform hover:scale-105 active:scale-95 w-full text-center"
              >
                Join Giveaway
              </a>
            </div>
