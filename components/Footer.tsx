        ...
        <div className="max-w-2xl mx-auto space-y-6 text-left">
          <div className="bg-[#FFF8E6] comic-border p-4 border-2">
            ...
            <div className="space-y-2">
              <div className="flex items-end justify-between bg-white p-2 comic-border">
                <div>
                  <div className="text-xs uppercase opacity-70">Solana</div>
                  <div className="font-mono text-sm">7GuDkrnmb7YpnM44huN1ZxJHk1xxhekzpqvh69teK1wz</div>
                </div>
                <div className="flex">
              ...
              <div className="flex items-end justify-between bg-white p-2 comic-border">
                <div>
                  ...
                  <div className="font-mono text-sm">bc1pn84zrvf8x3c07x3lq7uxrpedl8eusnzncqavt3fkudl2pm7ydvxqx5gksj</div>
                </div>
                <div className="flex">
              ...
              <div className="flex items-end justify-between bg-white p-2 comic-border">
                <div>
                  ...
                  <div className="font-mono text-sm">0xdac17f958d2ee523a2206206994597c13d831ec7</div>
                </div>
                <div className="flex">
          ...
          <p className="text-xs text-gray-400 leading-tight">
            CATLANDIA is a fictional universe. Any resemblance to actual persons, cats, or political figures living or dead is purely for satirical purposes. $CATL is a utility-free meme token. Not an investment product. 
