    ...
    <section id="community" className="scroll-reveal opacity-0 translate-y-10 transition-all duration-700 space-y-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-white comic-border p-8 comic-shadow flex flex-col items-center text-center space-y-4">
          ...
          <p className="font-bold text-sm">Join the inner circle. Get the latest leaks and comic panels first.</p>
          <a href={LINKS.telegram} className="bg-black text-white px-6 py-2 comic-border font-bold uppercase transition-transform hover:scale-105">Join Now</a>
        </div>
        ...
        <div className="bg-white comic-border p-8 comic-shadow flex flex-col items-center text-center space-y-4">
          ...
          <p className="font-bold text-sm">The megaphone of Catlandia. Retweet the truth and spread the memes.</p>
          <a href={LINKS.x} className="bg-black text-white px-6 py-2 comic-border font-bold uppercase transition-transform hover:scale-105">Follow Us</a>
        </div>
        ...
        <div className="bg-[#D4AF37] comic-border p-8 comic-shadow flex flex-col items-center text-center space-y-4">
          ...
          <p className="font-bold text-sm">Read the complete story of Donald Meowp's rise to power.</p>
          <div className="space-y-2 w-full">
            <span className="block text-xs font-black uppercase bg-black text-white px-2 py-1 mb-2">Coming Soon</span>
            <a href="#" className="block bg-white text-black px-6 py-2 comic-border font-bold uppercase transition-transform hover:scale-105">Support Project</a>
          </div>
        </div>
      </div>
    </section>
