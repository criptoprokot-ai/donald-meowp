...
export const StickerPack: React.FC = () => {
  return (
    <section className="scroll-reveal opacity-0 translate-y-10 transition-all duration-700 relative overflow-hidden bg-[#D4AF37] comic-border p-12 md:p-20 comic-shadow">
      {/* Background Decorative Element */}
      <div className="absolute top-0 right-0 w-64 h-64 halftone opacity-10 -mr-20 -mt-20 rotate-12"></div>
      ...
      <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative h-[400px] flex items-center justify-center">
          ...
          <div className="relative w-full h-full">
            {/* Sticker 1 */}
            <div className="absolute top-0 left-0 transform -rotate-12 hover:rotate-0 transition-transform duration-300 z-10">
            ...
            {/* Sticker 2 */}
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rotate-6 hover:rotate-0 transition-transform duration-300 z-30">
            ...
            {/* Sticker 3 */}
            <div className="absolute bottom-0 right-0 transform rotate-12 hover:rotate-0 transition-transform duration-300 z-20">
              <div className="bg-white p-2 comic-border comic-shadow rounded-xl overflow-hidden w-48 h-48 md:w-64 md:h-64">
